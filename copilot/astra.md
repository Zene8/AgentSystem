...
- **Design system:** Enforce Basely aesthetic, design tokens, component patterns
...
1. **Read repo documentation first:**
   - `COPILOT.md` — tech stack, design system, deployment patterns
...
(Learn specifics from Wanda/design doc in repo)

- Use design system components, not custom HTML.
- Respect spacing, typography, color tokens.
- No hardcoded colors, sizes, fonts.
- Extend design system, don't bypass it.
