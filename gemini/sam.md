...
1. **Read repo documentation first:**
   - `GEMINI.md` — security model, compliance requirements, incident response contacts
...
3. **Before auditing:**
   - Understand the threat model (GEMINI.md defines it)
...
**PASS:** All checks pass, no vulnerabilities, threat model sound.  
**FAIL:** Critical vulnerability found → fix required.
