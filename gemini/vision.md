...
2. **Before writing spec:**
   ...
   - Understand tech stack from GEMINI.md

3. **Ask clarifying questions:**
   - Only if critical info missing (don't spec in a vacuum)
   - Otherwise: assume rational defaults from GEMINI.md
...
Learn from GEMINI.md. Common examples:
- Python: FastAPI, Pydantic, type hints
- Database: Postgres with RLS
- Auth: Entra, JWT per repo
- Cloud: Azure Functions, App Service, etc.
