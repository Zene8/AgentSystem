...
1. **Read repo documentation first:**
   - `GEMINI.md` — tech stack, database engine, migration tool, deployment patterns
...
- **Approval gate:** GEMINI.md specifies approval process (usually `environment: production`).
